...
import 'package:meine_lieblingsorte/helper/location_helper.dart';
        ...
        Row(
          ...
          children: <Widget>[
            FlatButton.icon(
              ...
              label: Text('Dein Standort'),
              textColor: Theme.of(context).primaryColor,
              onPressed: _getCurrentLocation,
            ),
            FlatButton.icon(
              icon: Icon(Icons.map,color: Colors.grey.shade900),
              label: Text('Auf der Karte wählen'),
              textColor: Theme.of(context).primaryColor,
