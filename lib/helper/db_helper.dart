...
class DBHelper {
  ...
  static Future<sql.Database> dataBase() async {
    ...
    return sql.openDatabase(path.join(dbPath, 'places.db'),
      ...
      return db.execute(
          ...
          'CREATE TABLE places(id TEXT PRIMARY KEY, title TEXT, describtion TEXT ,image TEXT, loc_lat REAL, loc_lng REAL, address TEXT )');
    }, version: 1);
  }
  ...
  final int results= await db.delete('places', where: 'id = ?',
